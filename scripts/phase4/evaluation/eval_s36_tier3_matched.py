"""
E1 matched-size control (NOT committed). Adapted from
eval_s36_tier3.py -- only DATA_COMBINED, NORM_COMBINED, the
model_paths dict values, and out_dir changed to point at the
r=1..7-restricted tier3_matched dataset/models. No logic, threshold,
or smoothing changes.
...
# Paths (Tier 3 H100)
DATA_COMBINED = Path("data/processed/tier3_matched/unified/combined_dataset.npz")
NORM_COMBINED = Path("data/processed/tier3_matched/unified/combined_normalization.json")
...
def evaluate_workload(workload_name, device, window_size=5, n_gen=5):
    ...
    # Load S36 model
    model_paths = {
        "bert": "models/phase4/timegan_s36_tier3_matched/s36_bert_vr05_fm15/generator.pt",
        "gpt2": "models/phase4/timegan_s36_tier3_matched/s36_gpt2_vr03_fm20/generator.pt",
        "resnet152": "models/phase4/timegan_s36_tier3_matched/s36_resnet152_vr04_fm10/generator.pt",
        "whisper": "models/phase4/timegan_s36_tier3_matched/s36_whisper_vr05_fm05/generator.pt",
        "yolo": "models/phase4/timegan_s36_tier3_matched/s36_yolo_vr03_fm12/generator.pt",
    }
...
def main():
    ...
    # Save S36 results
    out_dir = Path("outputs/phase4/timegan_s36_tier3_matched")
    out_dir.mkdir(parents=True, exist_ok=True)
    
    with open(out_dir / "s36_eval_results.json", "w") as f:
        json.dump({
    ...
    print("RESULTS SAVED")
    print("="*80)
    print(f"S36 results: {out_dir / 's36_eval_results.json'}")
    if s34_results:
