"""
Adapted from eval_s36_tier3.py for the Frame C hyperparameter
ablation. Adds --workload/--model-dir/--variant-tag CLI so a
single (workload, variant) checkpoint from
models/phase4/timegan_s36_tier3_sweep/ can be evaluated
directly, bypassing the frozen model_paths dict. Writes its
own per-variant result file
(outputs/phase4/timegan_s36_tier3_sweep/eval_<workload>_<variant_tag>.json)
...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default=None,
                        help="Directory containing generator.pt for a sweep variant "
                             "(e.g. models/phase4/timegan_s36_tier3_sweep/s36_bert_vr03_fm15)")
    ...
    # Save S36 results
    if sweep_mode:
        out_dir = Path("outputs/phase4/timegan_s36_tier3_sweep")
