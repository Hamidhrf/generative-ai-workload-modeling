"""
Adapted from postprocess_s36_tier3.py for H100 Tier 2 MIG data. Only
MODEL_PATHS and every data_dir default (6 function
signatures) changed to point at data/processed/tier2/unified
and models/phase4/timegan_s36_tier2. Post-processing logic
(cosine blend window=20, adaptive filter, memory
reconstruction) is byte-identical to the original -- frozen
per the S36 Tier 2 retrain plan.
...
def load_normalization_params(workload, data_dir='data/processed/tier2/unified'):
...
def load_real_data(data_dir='data/processed/tier2/unified'):
...
def compute_memory_stats(data_dir='data/processed/tier2/unified'):
    """
...
def compute_dropped_metric_stats(data_dir='data/processed/tier2/unified'):
    """
