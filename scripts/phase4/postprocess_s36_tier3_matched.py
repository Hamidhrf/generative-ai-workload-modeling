...
postprocess_s36_tier3.py -- only MODEL_PATHS and every data_dir default
(6 function signatures) changed to point at data/processed/tier3_matched/
unified and models/phase4/timegan_s36_tier3_matched. Post-processing
logic (cosine blend window=20, adaptive filter, memory reconstruction)
is byte-identical to postprocess_s36_tier3.py.
...
def load_normalization_params(workload, data_dir='data/processed/tier3_matched/unified'):
...
def load_real_data(data_dir='data/processed/tier3_matched/unified'):
...
def compute_memory_stats(data_dir='data/processed/tier3_matched/unified'):
    """
...
def compute_dropped_metric_stats(data_dir='data/processed/tier3_matched/unified'):
    """
...
def generate_postprocessed_traces(workload, replica_count, n_samples=1,
                                  ...
                                  data_dir='data/processed/tier3_matched/unified'):
    """
