"""
Adapted from timegan_s36_tier3.py for the Frame C
hyperparameter ablation. Adds --workload/--vr/--fm CLI
...
to models/phase4/timegan_s36_tier3_sweep/ and
outputs/phase4/timegan_s36_tier3_sweep/ so sweep runs never
...
def main():
    ...
    for wl in run_workloads:
        ...
        model_dir = Path(f"models/phase4/timegan_s36_tier3_sweep/{tag}")
